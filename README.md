...
С 2024 года занимаюсь разработкой на Python, реализуя проекты полного цикла: от проектирования архитектуры и бизнес-логики до контейнеризации, настройки CI/CD и развёртывания в production.
